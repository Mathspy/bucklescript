...
bsc_no_open_flags =  ${commonBsFlags} -bs-cross-module-opt -bs-package-name bs-platform-fix -bs-package-output commonjs:lib/js  -bs-package-output es6:lib/es6  -nopervasives  -unsafe -w +50 -warn-error A  
...
bsc_flags = ${commonBsFlags} -bs-cross-module-opt -bs-package-name bs-platform-fix -bs-package-output commonjs:lib/js  -bs-package-output es6:lib/es6   -nopervasives  -unsafe  -w +50 -warn-error A  -open Bs_stdlib_mini -I ./runtime
${ruleCC(ninjaCwd)}
${
  devmode
    ? `${cppoRule()}
...
${bsc_flags} = ${commonBsFlags} -bs-cross-module-opt -bs-package-name bs-platform-fix -bs-package-output commonjs:lib/js  -bs-package-output es6:lib/es6   ${warnings}  -I runtime  -I others
${ruleCC(ninjaCwd)}
${ninjaQuickBuidList([
  [
...
bsc_flags = -absname -bs-no-version-header  -bs-cross-module-opt -bs-package-name bs-platform-fix -bs-package-output commonjs:jscomp/test  -w -3-6-26-27-29-30-32..40-44-45-52-60-9-106+104  -warn-error A  -I runtime -I $stdlib -I others
${ruleCC(ninjaCwd)}
